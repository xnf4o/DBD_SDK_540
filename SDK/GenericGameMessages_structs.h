...
{
	unsigned char                                      UnknownData_JOWU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KQ2N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HBQC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FOrderDoneMessage
{
	...
	unsigned char                                      UnknownData_O9H6[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFAQMessage
{
	unsigned char                                      UnknownData_MXPE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2BZ5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ME2M[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DI9L[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLoginJsonMessage
{
	...
	unsigned char                                      UnknownData_SGG2[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z3D6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_42IY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N3WS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FI32[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JSVU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HXJ8[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7M5A[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
