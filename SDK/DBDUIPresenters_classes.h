...
public:
	...
	unsigned char                                      UnknownData_DTVU[0x3F];                                    // 0x00B9(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AU4S[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L0IB[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NMW9[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_58SZ[0x38];                                    // 0x0110(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9IGO[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VUFT[0x48];                                    // 0x0110(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8SL1[0x18];                                    // 0x0100(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_41Q6[0x50];                                    // 0x00C8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6B45[0x20];                                    // 0x00B8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_1538[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_0AJG[0x30];                                    // 0x0110(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3M66[0x18];                                    // 0x00E8(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_M3GW[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E8LN[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (PADDING)
