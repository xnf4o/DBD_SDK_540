...
public:
	...
	unsigned char                                      UnknownData_VPAT[0x4];                                     // 0x03D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PY5Z[0x4];                                     // 0x03EC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O2LK[0x10];                                    // 0x05B0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7LI0[0x4];                                     // 0x018C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1H53[0x4];                                     // 0x01A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1U9S[0x8];                                     // 0x05B8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_OV63[0x8];                                     // 0x04C8(0x0008) MISSED OFFSET (PADDING)
