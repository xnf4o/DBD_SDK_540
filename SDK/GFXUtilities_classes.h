...
{
public:
	unsigned char                                      UnknownData_11PX[0x60];                                    // 0x0210(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_P8QZ[0x24];                                    // 0x0054(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KI4Y[0x30];                                    // 0x0040(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KLIF[0x8];                                     // 0x04E8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_TQ5T[0x4];                                     // 0x0B6C(0x0004) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_6J70[0x7];                                     // 0x0211(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DL56[0x3];                                     // 0x0231(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11KT[0x8];                                     // 0x0240(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_52VX[0x8];                                     // 0x0288(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T1S7[0x2];                                     // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1VH[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IJU9[0x8];                                     // 0x0268(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_0H1W[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WE8O[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TPTN[0x2];                                     // 0x00E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4IND[0x1];                                     // 0x00EF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3MXD[0x10];                                    // 0x0100(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KK5R[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BGLQ[0x8];                                     // 0x04E8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_YWWQ[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
