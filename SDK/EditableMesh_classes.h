...
public:
	...
	int                                                GeometryCollectionLODIndex;                                // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_721P[0x9C];                                    // 0x0044(0x009C) MISSED OFFSET (PADDING)
...
// 0x06E0 (FullSize[0x0710] - InheritedSize[0x0030])
class UEditableMesh : public UObject
{
public:
	unsigned char                                      UnknownData_VA7Q[0x390];                                   // 0x0030(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03C0(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7VKJ[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TextureCoordinateCount;                                    // 0x03D8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4MI5[0x148];                                   // 0x03DC(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                PendingCompactCounter;                                     // 0x0524(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                SubdivisionCount;                                          // 0x0528(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_IYVM[0x1E4];                                   // 0x052C(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	int                                                StaticMeshLODIndex;                                        // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_QRH4[0xA4];                                    // 0x0044(0x00A4) MISSED OFFSET (PADDING)
