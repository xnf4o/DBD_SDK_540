...
public:
	...
	unsigned char                                      UnknownData_5G25[0x18];                                    // 0x00D8(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9QU6[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_R5P4[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_OS3C[0x27];                                    // 0x00B9(0x0027) MISSED OFFSET (PADDING)
