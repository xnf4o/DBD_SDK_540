...
struct FKey
{
	struct FName                                       KeyName;                                                   // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_EXVT[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
