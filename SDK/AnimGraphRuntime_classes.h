...
public:
	...
	unsigned char                                      UnknownData_JO9Q[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2YAQ[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5FJG[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UN62[0x30];                                    // 0x0080(0x0030) MISSED OFFSET (PADDING)
