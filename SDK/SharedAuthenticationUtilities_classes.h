...
public:
	...
	unsigned char                                      UnknownData_E6JY[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YY6M[0xC0];                                    // 0x00C8(0x00C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_NIZE[0x38];                                    // 0x0038(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_K6C5[0x37];                                    // 0x0261(0x0037) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KIJC[0x18];                                    // 0x0260(0x0018) MISSED OFFSET (PADDING)
