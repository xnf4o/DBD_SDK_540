...
{
public:
	unsigned char                                      UnknownData_AM83[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DX4I[0x14];                                    // 0x00C4(0x0014) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.NetSynchedClock");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.NetUtils");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_9LP9[0x78];                                    // 0x0230(0x0078) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.NetworkFenceActor");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZDUT[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.ServerCorrectionDisablerComponent");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_VLW0[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.ServerTimeProviderComponent");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_K00H[0x60];                                    // 0x00B8(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5JX1[0xC];                                     // 0x012C(0x000C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NetworkUtilities.TimerObject");
		return ptr;
	}
