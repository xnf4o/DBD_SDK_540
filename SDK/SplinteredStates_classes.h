...
{
public:
	unsigned char                                      UnknownData_KD1O[0x4B8];                                   // 0x0038(0x04B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SplinteredStates.SplinteredStatesSubsystem");
		return ptr;
	}
