...
public:
	...
	unsigned char                                      UnknownData_IJFM[0x2];                                     // 0x0642(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Slasher22.AB_Menu_Slasher22_C");
		return ptr;
	}
