...
{
public:
	unsigned char                                      UnknownData_8V29[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z1I3[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OHB2[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
