...
public:
	...
	unsigned char                                      UnknownData_UXZ0[0x40];                                    // 0x02B0(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZBVC[0x14];                                    // 0x05BC(0x0014) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LADI[0x8];                                     // 0x05B8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TDAA[0x58];                                    // 0x05F8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2PSP[0x8];                                     // 0x0330(0x0008) MISSED OFFSET (PADDING)
