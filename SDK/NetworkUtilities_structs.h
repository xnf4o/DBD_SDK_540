...
struct FFloat_NetQuantize8
{
	...
	unsigned char                                      UnknownData_NIND[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (PADDING)
...
struct FReplicationTimerData
{
	...
	unsigned char                                      UnknownData_EH13[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FAssetNetIdRow : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_HFA0[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K0BR[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HNTX[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9QIP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QLMY[0xC];                                     // 0x002C(0x000C) MISSED OFFSET (PADDING)
