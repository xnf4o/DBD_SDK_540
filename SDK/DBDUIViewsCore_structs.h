...
struct FOnboardingTutorialButtonViewData
{
	...
	unsigned char                                      UnknownData_34KH[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PEJO[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FPendingTutorialData
{
	...
	unsigned char                                      UnknownData_VAXW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerStatusAssets
{
	...
	unsigned char                                      UnknownData_S7WN[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubtitlesEntry
{
	...
	unsigned char                                      UnknownData_HVN6[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FTextBlockOverrideProperties
{
	...
	unsigned char                                      UnknownData_87C7[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RIHR[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D01K[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZWZI[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FTabWidgetData
{
	...
	unsigned char                                      UnknownData_ARWI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OFOZ[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8NAV[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_19Z4[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FInputPromptDataRow : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_3C5V[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FTooltipWidgetData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_G52V[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
