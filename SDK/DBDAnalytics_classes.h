...
{
public:
	unsigned char                                      UnknownData_7U2T[0x38D8];                                  // 0x0038(0x38D8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_30QF[0xE8];                                    // 0x00B8(0x00E8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_82I9[0xB8];                                    // 0x00B8(0x00B8) MISSED OFFSET (PADDING)
