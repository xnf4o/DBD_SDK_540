...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_OSA1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8QH5[0x4];                                     // 0x0001(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_7G2P[0x42];                                    // 0x001E(0x0042) MISSED OFFSET (PADDING)
