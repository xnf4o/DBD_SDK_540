...
public:
	...
	unsigned char                                      UnknownData_XYAH[0x3];                                     // 0x033D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_TSKH[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_AQ6W[0x30];                                    // 0x06E0(0x0030) MISSED OFFSET (PADDING)
