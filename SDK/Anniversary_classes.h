...
{
public:
	unsigned char                                      UnknownData_WQMN[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_YA8F[0x28];                                    // 0x06E0(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NZ7[0xB];                                     // 0x0715(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7PE9[0x7];                                     // 0x0211(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTagStateBool                               _isCrownEventActive;                                       // 0x0218(0x0030) (Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OWK5[0x28];                                    // 0x0248(0x0028) MISSED OFFSET (PADDING)
