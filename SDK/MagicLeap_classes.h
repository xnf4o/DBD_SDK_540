...
public:
	...
	unsigned char                                      UnknownData_FNAD[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QQJY[0x50];                                    // 0x0188(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_69AR[0x8];                                     // 0x0210(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WR4Z[0x6];                                     // 0x022A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8RR3[0x3];                                     // 0x0239(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MLTD[0x3];                                     // 0x0241(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TK66[0x5];                                     // 0x024B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_61KB[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1XIU[0xC];                                     // 0x0294(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_I65J[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YKC4[0x68];                                    // 0x00B8(0x0068) MISSED OFFSET (PADDING)
