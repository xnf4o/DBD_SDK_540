...
struct FInputChord
{
	...
	unsigned char                                      bShift : 1;                                                // 0x0020(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bCtrl : 1;                                                 // 0x0020(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bAlt : 1;                                                  // 0x0020(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bCmd : 1;                                                  // 0x0020(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_12XN[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenuEntry
{
	...
	unsigned char                                      UnknownData_BW9T[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_94Q5[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_C5BT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, struct FCustomizedToolMenuEntry> Entries;                                                   // 0x0010(0x0050) (NativeAccessSpecifierPublic)
	TMap<struct FName, struct FCustomizedToolMenuSection> Sections;                                                  // 0x0060(0x0050) (NativeAccessSpecifierPublic)
	TMap<struct FName, struct FCustomizedToolMenuNameArray> EntryOrder;                                                // 0x00B0(0x0050) (NativeAccessSpecifierPublic)
	TArray<struct FName>                               SectionOrder;                                              // 0x0100(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_C4X3[0xE0];                                    // 0x0110(0x00E0) MISSED OFFSET (PADDING)
