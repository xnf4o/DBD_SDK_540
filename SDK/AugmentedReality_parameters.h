...
struct UARBlueprintLibrary_PinComponentToTraceResult_Params
{
	...
	struct FName                                       DebugName;                                                 // 0x0000(0x000C)  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct UARBlueprintLibrary_LineTraceTrackedObjects3D_Params
{
	...
	TArray<struct FARTraceResult>                      ReturnValue;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
	AugmentedReality_EARSessionType                    SessionType;                                               // 0x0000(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FARVideoFormat>                      ReturnValue;                                               // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct AARSharedWorldPlayerController_ClientUpdatePreviewImageData_Params
{
	...
	TArray<unsigned char>                              Buffer;                                                    // 0x0000(0x0010)  (ConstParm, Parm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
