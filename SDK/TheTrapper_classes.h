...
public:
	...
	unsigned char                                      UnknownData_8088[0x3];                                     // 0x0539(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZP23[0x4];                                     // 0x0544(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3XFM[0x60];                                    // 0x0568(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7MIK[0x20];                                    // 0x05D0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N8Q1[0xB];                                     // 0x0285(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5OXK[0x4];                                     // 0x06D8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_L0C2[0x8];                                     // 0x06F8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KSI7[0x50];                                    // 0x0710(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2YZG[0x1];                                     // 0x0788(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C9P1[0x6];                                     // 0x078A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AXWD[0x20];                                    // 0x0770(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_64KF[0x8];                                     // 0x05C8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JMYN[0x4];                                     // 0x05E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X3N4[0x8];                                     // 0x0638(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GMY3[0x3C];                                    // 0x05E4(0x003C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TRQG[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_9TW4[0x10];                                    // 0x0700(0x0010) MISSED OFFSET (PADDING)
