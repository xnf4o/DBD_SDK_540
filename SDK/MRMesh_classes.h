...
public:
	...
	unsigned char                                      UnknownData_2P55[0x4];                                     // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9LQ[0x4];                                     // 0x025C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GUFV[0x18];                                    // 0x0268(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_42MN[0x8];                                     // 0x0428(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_65YT[0x5];                                     // 0x043B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZW4I[0x40];                                    // 0x0460(0x0040) MISSED OFFSET (PADDING)
