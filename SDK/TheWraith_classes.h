...
{
public:
	unsigned char                                      UnknownData_TQHW[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_P7MV[0xC];                                     // 0x0644(0x000C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class TheWraith.WraithAnimInstance");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_CLEP[0x68];                                    // 0x0138(0x0068) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class TheWraith.WraithBurnable");
		return ptr;
	}
