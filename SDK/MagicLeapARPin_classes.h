...
public:
	...
	unsigned char                                      UnknownData_HWMT[0x2];                                     // 0x0226(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_71VQ[0xD0];                                    // 0x0270(0x00D0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y7JO[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
