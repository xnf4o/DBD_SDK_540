...
public:
	...
	unsigned char                                      UnknownData_I4L1[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class DBDGameplayPresenter.SurvivorStatusComponent");
		return ptr;
	}
