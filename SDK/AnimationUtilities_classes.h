...
{
public:
	unsigned char                                      UnknownData_EJ18[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LTTF[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5W8U[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2LA[0x30];                                    // 0x0240(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D0X5[0x54];                                    // 0x02AC(0x0054) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EBBZ[0xB0];                                    // 0x00B8(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3IM[0x2];                                     // 0x0176(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J8L3[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WHXV[0x8];                                     // 0x0188(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9F75[0x34];                                    // 0x019C(0x0034) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X51K[0x10];                                    // 0x00D0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WW15[0x4];                                     // 0x01F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_BWPY[0x4];                                     // 0x01DC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YX78[0x48];                                    // 0x00B8(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8TYX[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (PADDING)
