...
{
public:
	unsigned char                                      UnknownData_MPK9[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V1NM[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9S5R[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0IOW[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NEDU[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0HVH[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T81Q[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O1F0[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K343[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TMG5[0x38];                                    // 0x0090(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ANV5[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBrushStampData                             LastBrushStamp;                                            // 0x00D4(0x00B0) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_X3DA[0x14];                                    // 0x0184(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_72BQ[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_38XC[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LC1V[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_VNJ9[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UKD2[0x48];                                    // 0x0038(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_P2N3[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D32P[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T1F6[0x14];                                    // 0x00E4(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_M2NH[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0040(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_B373[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRW0[0x10];                                    // 0x00D0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MAED[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_NH3P[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Origin;                                                    // 0x0038(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                     Direction;                                                 // 0x0044(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_SSGI[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FVector                                     Origin;                                                    // 0x0038(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_OUEC[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1VVD[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AW30[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6AF5[0x2];                                     // 0x007E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SO6Q[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D8DZ[0x18];                                    // 0x00A0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LRJM[0xA0];                                    // 0x0080(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJFP[0x1F];                                    // 0x0121(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TP6I[0x140];                                   // 0x0140(0x0140) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TE0D[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L4F8[0x8];                                     // 0x0440(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_YQYF[0x10];                                    // 0x0460(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2E2Q[0xC];                                     // 0x0454(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KPA0[0xE];                                     // 0x0482(0x000E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X1JW[0xE];                                     // 0x0462(0x000E) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_54YQ[0x3];                                     // 0x046D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MATE[0xB];                                     // 0x0475(0x000B) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HVSM[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FRWS[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T5M9[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UIJO[0xE];                                     // 0x0032(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N14N[0x70];                                    // 0x0048(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZQBQ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W0SA[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveGizmoBuilder*> GizmoBuilders;                                             // 0x0060(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_80VL[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_78BX[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZPVQ[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FString, class UInteractiveToolBuilder*> ToolBuilders;                                              // 0x0098(0x0050) (Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_85Q9[0x58];                                    // 0x00E8(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HU5H[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_OCR6[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5KFH[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HMFT[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1JQP[0x98];                                    // 0x00A8(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QX64[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ML1C[0xF8];                                    // 0x0038(0x00F8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XGPO[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HR5Q[0xB0];                                    // 0x0080(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DXOV[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O96H[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PK0W[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E7I6[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_GRO6[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0050(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      TransformSource[0x10];                                     // 0x00A0(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_Z4H4[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9X7E[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_MQ9U[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	struct FVector                                     CurScaleOrigin;                                            // 0x008C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YDVW[0x8];                                     // 0x0098(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x00A0(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_CWYM[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0050(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      TransformSource[0x10];                                     // 0x00A0(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_YX5O[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  InitialTransform;                                          // 0x0100(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	unsigned char                                      UnknownData_267H[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AxisSource[0x10];                                          // 0x0040(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      ParameterSource[0x10];                                     // 0x0060(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      HitTarget[0x10];                                           // 0x0070(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      StateTarget[0x10];                                         // 0x0080(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	...
	unsigned char                                      UnknownData_EV56[0x14];                                    // 0x00F4(0x0014) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_71D6[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AN0G[0x40];                                    // 0x0080(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YRID[0x6F];                                    // 0x00C1(0x006F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_28RX[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4DDZ[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H3N5[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WP6W[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      TransactionManager[0x10];                                  // 0x0030(0x0010) UNKNOWN PROPERTY: InterfaceProperty
	unsigned char                                      UnknownData_ZELL[0x88];                                    // 0x0068(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NYSP[0x90];                                    // 0x0030(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_HLIB[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5K4N[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EJCE[0x3];                                     // 0x0052(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_ZEL9[0x98];                                    // 0x0058(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YN0I[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HITH[0x18];                                    // 0x0178(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JR4A[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3UYJ[0x16];                                    // 0x007A(0x0016) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_O6EO[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_55CA[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WIO8[0x80];                                    // 0x0060(0x0080) MISSED OFFSET (PADDING)
