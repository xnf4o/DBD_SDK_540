...
{
public:
	unsigned char                                      UnknownData_GBNW[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InputUtilities.AxisFlick");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZNHX[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1B0J[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InputUtilities.AxisFlickMasher");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_IEW2[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0O0T[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InputUtilities.ButtonPressTracker");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_QF75[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InputUtilities.InputMasher");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_9IQM[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InputUtilities.VirtualKeyboard");
		return ptr;
	}
