...
struct FSnowmanSpawnLocationData
{
	...
	unsigned char                                      UnknownData_4JHV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DZOA[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
