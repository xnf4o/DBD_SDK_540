...
struct UMagicLeapHMDFunctionLibrary_SetStabilizationDepthActor_Params
{
	...
	bool                                               bSetFocusActor;                                            // 0x0000(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UMagicLeapHMDFunctionLibrary_SetFocusActor_Params
{
	...
	bool                                               bSetStabilizationActor;                                    // 0x0000(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UMagicLeapMeshTrackerComponent_SelectMeshBlocks_Params
{
	...
	TArray<struct FMagicLeapMeshBlockRequest>          RequestedMesh;                                             // 0x0000(0x0010)  (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UMagicLeapRaycastFunctionLibrary_MakeRaycastQueryParams_Params
{
	...
	float                                              HorizontalFovDegrees;                                      // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               CollideWithUnobserved;                                     // 0x0000(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                UserData;                                                  // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMagicLeapRaycastQueryParams                ReturnValue;                                               // 0x0000(0x0038)  (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
