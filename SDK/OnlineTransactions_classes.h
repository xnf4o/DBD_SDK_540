...
{
public:
	unsigned char                                      UnknownData_T6A3[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FCVE[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UFGY[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2LL9[0x68];                                    // 0x00B8(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IY0O[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
