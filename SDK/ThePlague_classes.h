...
public:
	...
	unsigned char                                      UnknownData_B5ZO[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class ThePlague.PlagueSurvivorAnalyticsComponent");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_UGCZ[0x58];                                    // 0x0508(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class ThePlague.SicknessSurvivorSubAnimInstance");
		return ptr;
	}
