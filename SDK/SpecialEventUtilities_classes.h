...
public:
	...
	unsigned char                                      UnknownData_KC5A[0x7];                                     // 0x0349(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZWJJ[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
public:
	class URespawningEventComponent*                   _respawningEventComponent;                                 // 0x00B8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OJ17[0x40];                                    // 0x00C0(0x0040) MISSED OFFSET (PADDING)
