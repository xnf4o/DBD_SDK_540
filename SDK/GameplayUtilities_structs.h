...
struct FAuthorityDiscernedCharacter
{
	...
	unsigned char                                      UnknownData_0YMO[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	class ACharacter*                                  _character;                                                // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_ARPX[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FHitValidatorInstigatorParams
{
	...
	unsigned char                                      UnknownData_SC4V[0x48];                                    // 0x0008(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M2GH[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
struct FHitValidatorTargetParams
{
	...
	unsigned char                                      UnknownData_57UA[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FHitValidationReport
{
	...
	unsigned char                                      UnknownData_JN6V[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BWZ5[0xD];                                     // 0x00A3(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GLAS[0x2];                                     // 0x00FE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
