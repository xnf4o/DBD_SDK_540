...
struct FStatModifier
{
	...
	unsigned char                                      UnknownData_W6D0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GL89[0x1F];                                    // 0x0011(0x001F) MISSED OFFSET (PADDING)
...
struct FBaseStat
{
	unsigned char                                      UnknownData_5WGO[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UYNE[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
struct FNonTunableStat : public FBaseStat
{
	...
	unsigned char                                      UnknownData_V4D6[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FStatProperty : public FBaseStat
{
	...
	unsigned char                                      UnknownData_PYZH[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
