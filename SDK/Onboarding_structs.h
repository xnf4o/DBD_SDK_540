...
struct FOnboardingBotMatchDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_H9N4[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnboardingTutorialDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_E0P0[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSecretBotMatchNamesDefinition : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_BI6Y[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
