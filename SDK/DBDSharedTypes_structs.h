...
struct FProgressionUIDataRow : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_M3Y1[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurrencyUIDataRow : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_QFOV[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCurrencyProgressionUIData                  CurrencyProgressionUIData;                                 // 0x0010(0x00C0) (Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
struct FFriendData
{
	unsigned char                                      UnknownData_6TM8[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FHelpCategoryData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_N1K7[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRarityMaterialData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_57M8[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
