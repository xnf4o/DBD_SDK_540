...
public:
	...
	unsigned char                                      UnknownData_L0Q8[0x24];                                    // 0x006C(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JKO7[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_N90F[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
