...
struct FAnalogCursorData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_S0YH[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6BAD[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
