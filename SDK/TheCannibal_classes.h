...
{
public:
	unsigned char                                      UnknownData_6682[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TVBD[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTagStateBool                               _isInTantrum;                                              // 0x03E0(0x0030) (Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_MHHJ[0x20];                                    // 0x0410(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TWHL[0x18];                                    // 0x0168(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q7NY[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VXFV[0x28];                                    // 0x0158(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5SBE[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M6G3[0xC8];                                    // 0x00D8(0x00C8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q6LF[0x8];                                     // 0x01D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_BYHI[0x90];                                    // 0x0740(0x0090) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ERDW[0x10];                                    // 0x02A8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BTY7[0x10];                                    // 0x02A8(0x0010) MISSED OFFSET (PADDING)
