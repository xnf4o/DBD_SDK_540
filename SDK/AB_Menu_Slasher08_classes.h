...
public:
	...
	unsigned char                                      UnknownData_1HBZ[0x6];                                     // 0x0642(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Slasher08.AB_Menu_Slasher08_C");
		return ptr;
	}
