...
{
public:
	unsigned char                                      UnknownData_2EKM[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AMNP[0x138];                                   // 0x0070(0x0138) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3NOO[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V1WF[0x28];                                    // 0x0080(0x0028) MISSED OFFSET (PADDING)
