...
{
public:
	unsigned char                                      UnknownData_BAR6[0x8];                                     // 0x05B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FLP3[0x8];                                     // 0x0628(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5OR2[0xC];                                     // 0x03DC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ITLJ[0x1C];                                    // 0x00B8(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TAYJ[0x48];                                    // 0x0220(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8ZUW[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_7FH2[0x40];                                    // 0x06E0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11BV[0x4B];                                    // 0x0725(0x004B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GUSN[0x8];                                     // 0x0BA8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0NIS[0x4];                                     // 0x044C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_572T[0x10];                                    // 0x0348(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ZSKO[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NAIN[0x7];                                     // 0x0281(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7HD8[0x8];                                     // 0x00F0(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_20YP[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9SU1[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FTYU[0x28];                                    // 0x0108(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_OO13[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UBP2[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y9D2[0x8];                                     // 0x03F8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LHHL[0x8];                                     // 0x05B8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_TWBD[0xB8];                                    // 0x0438(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_93WK[0x8];                                     // 0x05D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KWBT[0x40];                                    // 0x04C8(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G9DY[0x24];                                    // 0x0554(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QEF6[0x10];                                    // 0x0500(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GE6E[0x4];                                     // 0x05A8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_PBMG[0x2];                                     // 0x05B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OL1Z[0x2];                                     // 0x05CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XKZ5[0x3];                                     // 0x05D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3ZB7[0x38];                                    // 0x05D8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RMMA[0x8];                                     // 0x0618(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LRNW[0x4];                                     // 0x0298(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F4DX[0x3];                                     // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0QPI[0x4];                                     // 0x02AC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IR9A[0xD];                                     // 0x00BB(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_363F[0x60];                                    // 0x01C0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ITO[0x18];                                    // 0x0270(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PLD9[0x4];                                     // 0x035C(0x0004) MISSED OFFSET (PADDING)
