...
public:
	...
	unsigned char                                      UnknownData_0ONZ[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_OSMS[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T9SP[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U7H9[0x2];                                     // 0x0482(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_80UA[0x30];                                    // 0x0494(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H7ZQ[0x7];                                     // 0x04C9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HQ55[0x2C];                                    // 0x0034(0x002C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JAGS[0x24];                                    // 0x0064(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YRAD[0x68];                                    // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E0I5[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1700[0xA8];                                    // 0x0060(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WTR2[0xA8];                                    // 0x0060(0x00A8) MISSED OFFSET (PADDING)
