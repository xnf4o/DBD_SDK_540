...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.DateTimeProvider");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.ArrayExt");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.BoolExt");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_6ERD[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.TimeProviderMock");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_KPMS[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.DateTimerUpdater");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.DebugUtilities");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class SystemUtilities.PlatformUtilities");
		return ptr;
	}
