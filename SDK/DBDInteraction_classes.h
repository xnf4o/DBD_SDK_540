...
public:
	...
	unsigned char                                      UnknownData_55DT[0x8];                                     // 0x07B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IHB9[0x20];                                    // 0x0840(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QCPU[0x10];                                    // 0x05B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4V3W[0x8];                                     // 0x06D8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_J5MC[0x8];                                     // 0x05D0(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_VFYQ[0x8];                                     // 0x05D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_QXT2[0x10];                                    // 0x05E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_58HL[0x8];                                     // 0x06D8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_39IG[0x8];                                     // 0x0750(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_DUVC[0x10];                                    // 0x05C0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MFNZ[0x8];                                     // 0x06D8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_PFFN[0x4];                                     // 0x05BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F9IY[0x8];                                     // 0x05C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZA3V[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_4BN9[0x14];                                    // 0x06E0(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XR49[0xB];                                     // 0x06F5(0x000B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JF5U[0x4];                                     // 0x05B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_205H[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RF5H[0x4];                                     // 0x06D8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_VJFQ[0x7];                                     // 0x06E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RP7Q[0x7];                                     // 0x06F9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DHTW[0x4];                                     // 0x070C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_API2[0x4];                                     // 0x071C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YI5H[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_1PEG[0x10];                                    // 0x0720(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7OYK[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_H0VU[0x8];                                     // 0x06E8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_D3BO[0xC];                                     // 0x05B4(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6E02[0x4];                                     // 0x06D8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_YWZY[0x60];                                    // 0x0708(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_602B[0x8];                                     // 0x0778(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IPJM[0x4];                                     // 0x06E4(0x0004) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_7ITL[0x4];                                     // 0x05E0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PSYZ[0x38];                                    // 0x05E8(0x0038) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class DBDInteraction.ThrowRockInteraction");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_T37K[0x8];                                     // 0x0710(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ATBG[0x4];                                     // 0x0724(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KZKB[0x10];                                    // 0x0730(0x0010) MISSED OFFSET (PADDING)
