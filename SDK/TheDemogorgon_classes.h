...
public:
	...
	unsigned char                                      UnknownData_5FYZ[0x7];                                     // 0x0279(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FM9S[0x40];                                    // 0x02B0(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XTGH[0x70];                                    // 0x0360(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_58GB[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_I9QF[0x68];                                    // 0x06E0(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3XRC[0x38];                                    // 0x0758(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2KBK[0x18];                                    // 0x0298(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OL8F[0x40];                                    // 0x04F0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LYF1[0xD];                                     // 0x0533(0x000D) MISSED OFFSET (PADDING)
