...
{
public:
	unsigned char                                      UnknownData_2IUL[0x40];                                    // 0x0108(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5RB3[0x18];                                    // 0x0150(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_IBJB[0x20];                                    // 0x0108(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_25CO[0x8];                                     // 0x0138(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SQR0[0x30];                                    // 0x0108(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PFVR[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class ACamperPlayer*, int>                    _remainingSurvivorHookStates;                              // 0x0118(0x0050) (Transient, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_BNX5[0x8];                                     // 0x0168(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SBCL[0x60];                                    // 0x0108(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FIR5[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_4JLU[0x88];                                    // 0x0108(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NPI5[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L7M9[0x10];                                    // 0x0120(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
