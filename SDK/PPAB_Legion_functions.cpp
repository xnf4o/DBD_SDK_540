...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PPAB_Legion.PPAB_Legion_C.AnimGraph");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function PPAB_Legion.PPAB_Legion_C.ExecuteUbergraph_PPAB_Legion");
