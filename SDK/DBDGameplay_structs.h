...
{
	unsigned char                                      UnknownData_G6VQ[0x24];                                    // 0x0000(0x0024) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PZGP[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PORR[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (PADDING)
