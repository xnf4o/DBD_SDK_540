...
struct FAgonyDisplayFxEvent
{
	...
	unsigned char                                      UnknownData_RKOC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TWQ3[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FSpawnedAttackPoint
{
	...
	unsigned char                                      UnknownData_4AD2[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YUEK[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R2IM[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P37V[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FSpawnedTormentTrailPoint
{
	...
	unsigned char                                      UnknownData_80HJ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
