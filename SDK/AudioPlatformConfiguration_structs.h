...
enum class AudioPlatformConfiguration_ESoundwaveSampleRateSettings : uint8_t
{
	...
	ESoundwaveSampleRateSettings__ESoundwaveSampleRateSettings_MAX = 6,
...
struct FPlatformRuntimeAudioCompressionOverrides
{
	...
	unsigned char                                      UnknownData_506J[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
