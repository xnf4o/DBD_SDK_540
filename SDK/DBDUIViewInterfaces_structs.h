...
struct FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_UR4K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTT2[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAddonViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_MZAI[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
struct FCharacterTooltipViewData
{
	...
	unsigned char                                      UnknownData_DW4A[0x1];                                     // 0x0057(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_29CU[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R0IJ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8EQY[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2PXY[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FCurrencyProgressionTooltipViewData
{
	...
	unsigned char                                      UnknownData_427I[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3RNB[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPriceViewData
{
	...
	unsigned char                                      UnknownData_50NO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UPJ5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FCustomizationTooltipViewData
{
	...
	unsigned char                                      UnknownData_Y5WQ[0x2];                                     // 0x0096(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VEQ8[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8GPR[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UTexture2D*                                  IconTexture;                                               // 0x0008(0x0008) (Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_AW7A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X2Y0[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (PADDING)
...
struct FPerkViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_JR4O[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FItemViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_FDEW[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DCGM[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4DDI[0x6];                                     // 0x008A(0x0006) MISSED OFFSET (PADDING)
...
struct FStatusEffectAlertViewData
{
	...
	unsigned char                                      UnknownData_7V3V[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScoreAlertViewData
{
	...
	unsigned char                                      UnknownData_URJD[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudObjectivesViewData
{
	...
	unsigned char                                      UnknownData_JBUA[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudObjectiveViewData
{
	DBDSharedTypes_EPlayerTeam                         playerTeam;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               isHatchOpen;                                               // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_IA9F[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                nbGeneratorsLeft;                                          // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FStatusEffectViewData
{
	...
	unsigned char                                      UnknownData_A62Y[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      IconTexture[0x30];                                         // 0x000C(0x0030) UNKNOWN PROPERTY: SoftObjectProperty
	DBDSharedTypes_EStatusEffectType                   StatusEffectType;                                          // 0x0040(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RGD4[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E8S7[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FInteractionProgressViewData
{
	...
	unsigned char                                      UnknownData_SKTW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       ID;                                                        // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_84CP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EFT1[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DKTI[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FMatchResultViewData
{
	...
	unsigned char                                      UnknownData_QWLZ[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOfferingViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_UTXA[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
struct FRewardWrapperViewData
{
	...
	unsigned char                                      UnknownData_ZSYZ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnboardingTutorialViewData
{
	...
	unsigned char                                      UnknownData_ZKLU[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LCMU[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOnboardingStepViewData
{
	...
	unsigned char                                      UnknownData_WG5S[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGhostStatusData
{
	...
	unsigned char                                      UnknownData_VUBK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNightmareStatusData
{
	...
	unsigned char                                      UnknownData_1XLS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPigStatusData
{
	...
	unsigned char                                      UnknownData_5F2D[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlagueStatusData
{
	...
	unsigned char                                      UnknownData_TA2D[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTricksterStatusData
{
	...
	unsigned char                                      UnknownData_JE4G[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FK25StatusData
{
	...
	unsigned char                                      UnknownData_JHW8[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FPlayerStatusViewData
{
	...
	unsigned char                                      UnknownData_LQIB[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UV4A[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y21T[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H0RV[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AVZT[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
struct FPowerViewData : public FBaseLoadoutPartViewData
{
	...
	unsigned char                                      UnknownData_VHNC[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EUTS[0x2];                                     // 0x0086(0x0002) MISSED OFFSET (PADDING)
...
struct FScreenIndicatorViewData
{
	...
	unsigned char                                      UnknownData_RM3F[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8CLB[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FSkillCheckViewData
{
	...
	unsigned char                                      UnknownData_O8CM[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FStartSequenceViewData
{
	...
	unsigned char                                      UnknownData_U05H[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ULH4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
