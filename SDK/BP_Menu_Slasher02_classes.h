...
{
public:
	unsigned char                                      UnknownData_P34R[0x4];                                     // 0x068C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Menu_Slasher02.BP_Menu_Slasher02_C");
		return ptr;
	}
