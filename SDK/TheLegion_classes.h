...
{
public:
	unsigned char                                      UnknownData_BUMQ[0x10];                                    // 0x0360(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LAD6[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7N0F[0x58];                                    // 0x00B8(0x0058) MISSED OFFSET (PADDING)
