...
struct FSecondaryInteractionProperties
{
	...
	unsigned char                                      UnknownData_TGRR[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42J9[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomTransformation
{
	...
	unsigned char                                      UnknownData_EYXC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerSavedProfileCumulativeData
{
	...
	unsigned char                                      UnknownData_EU3G[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OWN6[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_TWVQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZOL1[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1CXU[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FDependency
{
	...
	unsigned char                                      UnknownData_5FNM[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SBD8[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FForceSpawnTileData
{
	...
	unsigned char                                      UnknownData_J1Y1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FGeneratedLevelData
{
	...
	unsigned char                                      UnknownData_ZI5E[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3J6F[0x2];                                     // 0x0256(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MFMG[0x4];                                     // 0x027C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRegion
{
	...
	unsigned char                                      UnknownData_WW1D[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_A732[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRoleItemCategoryDropdown : public FCharacterDropdown
{
	...
	unsigned char                                      UnknownData_TU0F[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FGenderViewSetting
{
	...
	unsigned char                                      UnknownData_8GR2[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRoleGenderViewSetting
{
	...
	unsigned char                                      UnknownData_SIEF[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScreenshotViewSetting                      Settings;                                                  // 0x0010(0x0028) (Edit, NoDestructor, NativeAccessSpecifierPublic)
...
struct FArmIKSensorDatum
{
	...
	unsigned char                                      UnknownData_BVGV[0x24];                                    // 0x000C(0x0024) MISSED OFFSET (PADDING)
...
struct FModifierTickableConditionReplicatedData
{
	...
	unsigned char                                      UnknownData_TYXU[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FStatusEffectInitializationData
{
	...
	unsigned char                                      UnknownData_TV14[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YL08[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JLL2[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FPerkInitializationData
{
	...
	unsigned char                                      UnknownData_CJ42[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FGameBot
{
	...
	unsigned char                                      UnknownData_BPDJ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGamePresetData
{
	...
	unsigned char                                      UnknownData_HB01[0x5];                                     // 0x0073(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProgressionPoints
{
	...
	unsigned char                                      UnknownData_ANV7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActorSpawnerProperties
{
	...
	unsigned char                                      UnknownData_IYEL[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FActorVariationElements
{
	...
	unsigned char                                      UnknownData_LBWQ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAITrailEvent
{
	...
	unsigned char                                      UnknownData_7SOS[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V1DK[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAssetLibraryLoader
{
	...
	unsigned char                                      UnknownData_S61X[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FItemUIData
{
	...
	unsigned char                                      UnknownData_6KHD[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQRI[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FItemAvailability
{
	...
	unsigned char                                      UnknownData_Y8NB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2TP0[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomizationData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_WGY6[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConditionalMaterialReplacer
{
	...
	unsigned char                                      UnknownData_A0WE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBPAttachementSocketData
{
	...
	unsigned char                                      UnknownData_KA5Y[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUnlockSaveStatCondition
{
	...
	unsigned char                                      UnknownData_RHP6[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FCustomSoundFXData
{
	...
	unsigned char                                      UnknownData_EG4E[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomizationItemData : public FCustomizationData
{
	...
	unsigned char                                      UnknownData_5PFL[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HG6F[0x4];                                     // 0x025C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZ6F[0x3];                                     // 0x027D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_23D8[0x1];                                     // 0x02A3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_HBRL[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDataTableDropdown
{
	...
	unsigned char                                      UnknownData_PDW3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UJEU[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FDebugLoadoutPerk
{
	...
	unsigned char                                      UnknownData_JZMG[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FSlasherLoadout
{
	...
	unsigned char                                      UnknownData_Y5D4[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FYLF[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
struct FOngoingScoreData
{
	...
	unsigned char                                      UnknownData_HE5N[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ROO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedFearMarketItemInstance
{
	...
	unsigned char                                      UnknownData_5T5Z[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FLegacySavedBloodwebNodeProperties
{
	...
	unsigned char                                      UnknownData_VQTS[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedBloodwebNodeGate
{
	...
	unsigned char                                      UnknownData_PNYE[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedBloodwebChest
{
	...
	unsigned char                                      UnknownData_3ZJ7[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedBloodwebNode
{
	...
	unsigned char                                      UnknownData_TLT2[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6OSM[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedPlayerLoadoutData
{
	...
	unsigned char                                      UnknownData_83XE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7W3Z[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
struct FLegacyCharacterSavedProfileData
{
	...
	unsigned char                                      UnknownData_5SH3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacySavedDailyRitualInstance
{
	...
	unsigned char                                      UnknownData_G1Y2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VPKJ[0x1];                                     // 0x0047(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_71W6[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLegacyPlayerSavedProfileDataLocal
{
	...
	unsigned char                                      UnknownData_B0FG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LT2K[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SN0U[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1VDN[0x4];                                     // 0x0154(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HF6W[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SSTM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_408Z[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GVXU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9THW[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6F5W[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BZ4L[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
...
struct FSaveValidationData
{
	...
	unsigned char                                      UnknownData_I1Q2[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
struct FScoreValue : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_2KHU[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WMJU[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScoreCategoryData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_W9PG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerstateDataCache
{
	...
	unsigned char                                      UnknownData_CHIF[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FSurfaceTypeName : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_J152[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FToastButton
{
	...
	unsigned char                                      UnknownData_8BOI[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FToast : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_Z8A6[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDedicatedSessionSearchCompletedEventData
{
	...
	unsigned char                                      UnknownData_OPVV[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FResolutionQualityPair : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_9SSS[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDBDAttackTargetTracker
{
	...
	unsigned char                                      UnknownData_XCG4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBuiltLevelData
{
	...
	unsigned char                                      UnknownData_35QY[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2PB0[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ZE0[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (PADDING)
...
struct FOfferingData
{
	...
	unsigned char                                      UnknownData_LEEB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZHGP[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FPerMeshInstancingData
{
	...
	unsigned char                                      UnknownData_BQ6I[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (PADDING)
...
struct FDailyRitualInstance
{
	...
	unsigned char                                      UnknownData_ZS23[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5FFO[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
...
struct FFearMarketItemInstance
{
	...
	unsigned char                                      UnknownData_ZOCX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FWeightedItem
{
	...
	float                                              Weight;                                                    // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WENN[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FQuadrantSpawnItem
{
	...
	unsigned char                                      UnknownData_EJRW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FQuadrantSpawnCategories
{
	...
	unsigned char                                      UnknownData_D9KV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssignedPerkPropertiesV7
{
	...
	unsigned char                                      UnknownData_G27F[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FSavedCharacterLevelDataV7
{
	...
	unsigned char                                      UnknownData_PCPO[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSavedCharmSlotData
{
	...
	unsigned char                                      UnknownData_OOB1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCharacterKeyTuple
{
	...
	unsigned char                                      UnknownData_K35Z[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FShopTransactionItemParameters
{
	...
	unsigned char                                      UnknownData_V8HG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkillCheckDefinition
{
	...
	unsigned char                                      UnknownData_4WXA[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkillCheckResponse
{
	...
	unsigned char                                      UnknownData_RKRX[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LOU9[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSpecialEventObjectiveData
{
	...
	unsigned char                                      UnknownData_5RIV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C4Q6[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1TVL[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSpecialEventCinematicData
{
	...
	unsigned char                                      UnknownData_2Q20[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSpecialEventData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_L6B7[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T0FO[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6819[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0S7C[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DG6U[0x6];                                     // 0x0102(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_015N[0x7];                                     // 0x0171(0x0007) MISSED OFFSET (PADDING)
...
struct FSpecialEventLoadingTextData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_L1EO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBaseItemData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_26A2[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FItemData : public FBaseItemData
{
	...
	unsigned char                                      UnknownData_8OEM[0x2];                                     // 0x0186(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_23YE[0x3];                                     // 0x01BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_76OF[0x2];                                     // 0x01CE(0x0002) MISSED OFFSET (PADDING)
...
struct FStatusEffectProperties : public FItemData
{
	...
	unsigned char                                      UnknownData_KYK5[0x6];                                     // 0x0212(0x0006) MISSED OFFSET (PADDING)
...
struct FStatusViewProperties : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_DHJT[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HO4M[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStatusViewSource
{
	...
	unsigned char                                      UnknownData_YCA2[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2WUJ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_S0WB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D3KU[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
struct FStoreBannersData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_BXW2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1EH[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FVector                                     Location;                                                  // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OXKF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADJZ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAssignedPerkProperties
{
	...
	unsigned char                                      UnknownData_TXOH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FSavedCharacterLevelData
{
	...
	unsigned char                                      UnknownData_FB8M[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBloodwebNodeProperties
{
	...
	unsigned char                                      UnknownData_HOYL[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1I82[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBloodwebChest : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_84SL[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBloodwebNode
{
	...
	unsigned char                                      UnknownData_DHOO[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJSH[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerLoadoutData
{
	...
	unsigned char                                      UnknownData_V6ZJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IIY3[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
struct FSpecialEventSavedData
{
	...
	unsigned char                                      UnknownData_9RIB[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FPlayerSavedProfileDataLocal
{
	...
	unsigned char                                      UnknownData_I0W9[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKOL[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9AYH[0x4];                                     // 0x0204(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R4O4[0x6];                                     // 0x02B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_28RC[0x3];                                     // 0x030D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3FQR[0x7];                                     // 0x03B1(0x0007) MISSED OFFSET (PADDING)
...
struct FPlayerSavedProfileDataShared
{
	...
	unsigned char                                      UnknownData_86J1[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConsoleUserSettings
{
	...
	unsigned char                                      UnknownData_9YIH[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROWN[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KHID[0x2];                                     // 0x0042(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JEL6[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3079[0x1];                                     // 0x005F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FKQV[0x6];                                     // 0x0072(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0F9T[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJGN[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FPlayerPersistentData
{
	...
	unsigned char                                      UnknownData_88S9[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TJH9[0x98];                                    // 0x0138(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WA90[0x3];                                     // 0x0700(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_7POF[0x3];                                     // 0x0704(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_THMY[0x14];                                    // 0x070C(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HXRL[0x8];                                     // 0x0738(0x0008) MISSED OFFSET (PADDING)
...
struct FSectionLenghtsProperties
{
	...
	unsigned char                                      UnknownData_774L[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FQuadrantSpawnTypeProperties
{
	...
	unsigned char                                      UnknownData_FPXM[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_GMR7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QVOP[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_83VQ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventItemsContentTypeUIData
{
	...
	unsigned char                                      UnknownData_70WP[0x5];                                     // 0x0003(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_S4IA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XWF3[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XV3B[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (PADDING)
...
struct FAtlantaFreeTicketAffectedUIData
{
	...
	unsigned char                                      UnknownData_51MM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NC9F[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FSpecialEventUIInfo
{
	...
	unsigned char                                      UnknownData_MXV6[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BTC9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T5GV[0x5];                                     // 0x0083(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X1K7[0x6];                                     // 0x00A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1Z6Z[0x7];                                     // 0x00F9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4G85[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQY5[0x30];                                    // 0x0138(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AVG0[0x7];                                     // 0x0169(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GXQY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LIAM[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FLW8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_27S2[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PKF7[0x5];                                     // 0x012B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MIJM[0x77];                                    // 0x0139(0x0077) MISSED OFFSET (PADDING)
...
struct FAtlCookedMapDescription
{
	...
	unsigned char                                      UnknownData_S7ZF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHudEditorDragFromParentAxisLimit
{
	...
	unsigned char                                      UnknownData_ZK8D[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7G1S[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XFQG[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FDBDOutlineRenderStrategySelector
{
	...
	unsigned char                                      UnknownData_9XDT[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FLandingPageTabData
{
	...
	unsigned char                                      UnknownData_JTP9[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FInteractionPlayerProperties
{
	...
	unsigned char                                      UnknownData_849T[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FStoredInteraction
{
	...
	unsigned char                                      UnknownData_Y55S[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FInteractionPlayerProperties                _playerProperties;                                         // 0x000C(0x0050) (Transient, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_IO4Z[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FStoreFeaturedBannerUIData
{
	...
	unsigned char                                      UnknownData_MU5Y[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1CUZ[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y3UJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G45T[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (PADDING)
...
struct FStreamVideoUIData
{
	...
	unsigned char                                      UnknownData_BI2J[0xB];                                     // 0x0021(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ZST[0x50];                                    // 0x0090(0x0050) MISSED OFFSET (PADDING)
...
struct FAkEventWithSubtitle
{
	...
	unsigned char                                      UnknownData_1BZ7[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_72E6[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FInventorySlotData
{
	...
	unsigned char                                      UnknownData_R4C2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BW6N[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LQN1[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RW63[0x1];                                     // 0x00F7(0x0001) MISSED OFFSET (PADDING)
...
struct FTallyItemChangedData
{
	...
	unsigned char                                      UnknownData_0BAE[0x2];                                     // 0x02EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBaseTooltipData
{
	...
	unsigned char                                      UnknownData_ODOQ[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
struct FTeachableTooltipData : public FBaseTooltipData
{
	...
	unsigned char                                      UnknownData_67ZS[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8W28[0x6];                                     // 0x00D2(0x0006) MISSED OFFSET (PADDING)
...
struct FTransactionEventData
{
	...
	unsigned char                                      UnknownData_D6V2[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6UGP[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DWVT[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FPerPlatformTunable : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_6K7K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTunableValue : public FDBDTunableRowBase
{
	...
	unsigned char                                      UnknownData_5809[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTutorialObjective : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_7X9F[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_30XD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaSettingMenuData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_TKLL[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7TQ5[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FPlayerInfoData
{
	...
	unsigned char                                      UnknownData_AOWA[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVariationData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_52BP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVideoThumbnailProperties : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_7Q8F[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FArchivesVignetteEntry : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_7D63[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FWalesCypherEventData
{
	...
	unsigned char                                      UnknownData_LJWM[0x1];                                     // 0x0027(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3B48[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FXpBonusData
{
	...
	unsigned char                                      UnknownData_6NNI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FBloodDecal
{
	unsigned char                                      UnknownData_61UU[0x6C];                                    // 0x0000(0x006C) MISSED OFFSET (PADDING)
...
{
	DeadByDaylight_EDirection                          Direction;                                                 // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AHO3[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraAttachment
{
	...
	unsigned char                                      UnknownData_PX09[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FDBDTimer
{
	unsigned char                                      UnknownData_Y26G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z2GH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WSM5[0xB];                                     // 0x0019(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCharacterToolData
{
	...
	unsigned char                                      UnknownData_E1TP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                characterId;                                               // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       OutfitId;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FNamedButton
{
	...
	unsigned char                                      UnknownData_OC4Z[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChargeData
{
	...
	unsigned char                                      UnknownData_ALQT[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FTargetFocusTimer
{
	...
	unsigned char                                      UnknownData_NFM5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FChaseUpdateInfo
{
	...
	unsigned char                                      UnknownData_CF3P[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FCinematic
{
	...
	unsigned char                                      UnknownData_J103[0x1F];                                    // 0x0039(0x001F) MISSED OFFSET (PADDING)
...
struct FCustomizedMeshPart
{
	...
	unsigned char                                      UnknownData_S0X5[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_46SS[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Type;                                                      // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SU6K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOfferingRevealDelays
{
	...
	unsigned char                                      UnknownData_SYJ0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_JIJC[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FKillerItemProperty
{
	...
	unsigned char                                      UnknownData_5G01[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FSurvivorItemProperties
{
	...
	unsigned char                                      UnknownData_X1GF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEscapeStrategyProperty
{
	...
	unsigned char                                      UnknownData_ME0L[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MEHW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	DeadByDaylight_EscapeStrategyType                  Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PPP4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayElementsPopulation
{
	...
	unsigned char                                      UnknownData_WZ1J[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FManagedGameplayElementsPopulation
{
	...
	unsigned char                                      UnknownData_KG4O[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      GameplayElementBlueprint[0x30];                            // 0x0001(0x0030) UNKNOWN PROPERTY: SoftClassProperty
	...
	unsigned char                                      UnknownData_NJP7[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FSurvivorGroupingProbability
{
	...
	unsigned char                                      UnknownData_Y1PF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSpecialBehaviourPopulation
{
	...
	unsigned char                                      UnknownData_RBHA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDependencyElementSubstitutions : public FElementSubstitutions
{
	...
	unsigned char                                      UnknownData_K4XY[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FDependencyElementAddition
{
	...
	unsigned char                                      UnknownData_C4KG[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayElementAddition
{
	...
	unsigned char                                      UnknownData_X7S8[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                _numberToAdd;                                              // 0x0034(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_XMI7[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayElementSubstitutions : public FElementSubstitutions
{
	...
	unsigned char                                      UnknownData_FA3S[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FEventSubstitionData
{
	...
	unsigned char                                      UnknownData_DP3L[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADPO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_88PB[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScoreCategoryUIExtraData
{
	...
	unsigned char                                      UnknownData_GUEF[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FEmblemProgressionData
{
	...
	unsigned char                                      UnknownData_ZOM4[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FEmblemSlotData
{
	...
	unsigned char                                      UnknownData_GAJC[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOM4[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LZAC[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M7I1[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FTallyScorePipsData
{
	...
	unsigned char                                      UnknownData_GBG4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H75F[0x1];                                     // 0x002F(0x0001) MISSED OFFSET (PADDING)
...
struct FTallyPlayerResultData
{
	...
	unsigned char                                      UnknownData_IYG6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5W0S[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D0N2[0x2];                                     // 0x0276(0x0002) MISSED OFFSET (PADDING)
...
struct FTeachableData
{
	...
	unsigned char                                      UnknownData_TULE[0x3];                                     // 0x00F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNativeBlockIndicatorData
{
	...
	unsigned char                                      UnknownData_NQVZ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVaultData
{
	unsigned char                                      UnknownData_QTGP[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FScoreEventData
{
	...
	unsigned char                                      UnknownData_YUUA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerHUDInfos : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_OVNN[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRankGroupDefinition
{
	...
	unsigned char                                      UnknownData_SDPG[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKeyTupleBool
{
	...
	unsigned char                                      UnknownData_DILS[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSavedSpecialEventDataV7
{
	...
	unsigned char                                      UnknownData_7MY7[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HEJF[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSaveDataV7 : public FSaveDataBase
{
	...
	unsigned char                                      UnknownData_CCR1[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KKFW[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GZJZ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6KCB[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0ET7[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4UXD[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9V1R[0x6];                                     // 0x03B2(0x0006) MISSED OFFSET (PADDING)
...
struct FSaveDataV8 : public FSaveDataBase
{
	...
	TArray<struct FName>                               offerings;                                                 // 0x0028(0x0010) (ZeroConstructor, SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               FirstTimePlaying;                                          // 0x0038(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GO1V[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                ConsecutiveMatchStreak;                                    // 0x003C(0x0004) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               HasBeenGivenKillerTutorialEndReward;                       // 0x0040(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               HasBeenGivenSurvivorTutorialEndReward;                     // 0x0041(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               HasSeenBloodpointsOnboardingCurrencyPopup;                 // 0x0042(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               HasSeenAuricCellsOnboardingCurrencyPopup;                  // 0x0043(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               HasSeenIridescentShardsOnboardingCurrencyPopup;            // 0x0044(0x0001) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BF02[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	uint64_t                                           CurrentSeasonTicks;                                        // 0x0048(0x0008) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                LastConnectedCharacterIndex;                               // 0x0050(0x0004) (ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KEJE[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     DisconnectPenaltyTime;                                     // 0x0058(0x0010) (ZeroConstructor, SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FString                                     LastMatchEndTime;                                          // 0x0068(0x0010) (ZeroConstructor, SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FString                                     LastMatchStartTime;                                        // 0x0078(0x0010) (ZeroConstructor, SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FString                                     LastKillerMatchEndTime;                                    // 0x0088(0x0010) (ZeroConstructor, SaveGame, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_UP3Y[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NCBF[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U122[0x4];                                     // 0x03A4(0x0004) MISSED OFFSET (PADDING)
...
struct FCharmSlot
{
	...
	unsigned char                                      UnknownData_6UUB[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMapSoundsToAvoid
{
	...
	unsigned char                                      UnknownData_642E[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FDBD_SoundSpawnerData
{
	...
	unsigned char                                      UnknownData_Z6B4[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttackDelegatePair
{
	...
	unsigned char                                      UnknownData_D841[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FSpawnInfo
{
	...
	unsigned char                                      UnknownData_KFCF[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCamperLoadout
{
	...
	unsigned char                                      UnknownData_ORQF[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInboxMessageUIData
{
	...
	unsigned char                                      UnknownData_HYC6[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y79Y[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9NLU[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPartyMemberUIData
{
	...
	unsigned char                                      UnknownData_XKGJ[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EVEC[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2VJQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1O9C[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VHXP[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8DLG[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FTooltipPressedData
{
	...
	unsigned char                                      UnknownData_YQQ0[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FCamperHealResult
{
	...
	unsigned char                                      UnknownData_7NMV[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhaseWalkInfo
{
	...
	unsigned char                                      UnknownData_SEWU[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZVOS[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDetectedStimulus
{
	...
	unsigned char                                      UnknownData_N8LA[0x2C];                                    // 0x0030(0x002C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_COY5[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4B0U[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FAnimationMapping : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_UFMG[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FArchiveQuestSpecialBehaviour : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_O5HW[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q1NK[0x1];                                     // 0x0043(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FArchiveQuestObjectiveDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_FS2X[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FArchiveNodeDefinition : public FDBDTableRowBaseWithId
{
	...
	unsigned char                                      UnknownData_K0QV[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0NMQ[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FW63[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SD8T[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VAV5[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAtlantaBaseEventsUIData
{
	...
	unsigned char                                      UnknownData_IEQL[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7V0V[0x30];                                    // 0x00E8(0x0030) MISSED OFFSET (PADDING)
...
struct FAtlantaDeepLinkData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_VA4U[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
...
struct FDeviceProfiles : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_WBUE[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAtlantaEventElementUIData
{
	...
	unsigned char                                      UnknownData_UF3G[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaFreeTicketCombinedData
{
	...
	unsigned char                                      UnknownData_KFYF[0x3];                                     // 0x01F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W14F[0x4];                                     // 0x0204(0x0004) MISSED OFFSET (PADDING)
...
struct FAtlantaKillerSoundDistanceData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_1LGR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAtlantaKillerSoundConditionData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_S48Q[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FAtlantaKillerSoundIndicatorData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_HODL[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WP3P[0x40];                                    // 0x00E8(0x0040) MISSED OFFSET (PADDING)
...
struct FAtlantaNoiseIndicatorDistanceData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_5I7S[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAtlantaOnBoardingData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_7C2A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaRewardUIData
{
	...
	unsigned char                                      UnknownData_X0K3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T56E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3F7T[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaRitualRewardUIData
{
	...
	unsigned char                                      UnknownData_229B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_44ZC[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FGamePersistentData
{
	...
	unsigned char                                      UnknownData_C34E[0x70];                                    // 0x0090(0x0070) MISSED OFFSET (PADDING)
...
struct FFirecrackerEffectData
{
	...
	unsigned char                                      UnknownData_FYBR[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FFootStep
{
	...
	unsigned char                                      UnknownData_ZGMW[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8E2W[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FGameEventData
{
	...
	unsigned char                                      UnknownData_0YJG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NUZM[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FDamageData
{
	...
	unsigned char                                      UnknownData_K80Q[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MM9A[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
...
struct FPlayerFloatTuple
{
	...
	float                                              value;                                                     // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6N1S[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FThemeProperties
{
	...
	unsigned char                                      UnknownData_911J[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      AudioThemeSoundBank[0x30];                                 // 0x003C(0x0030) UNKNOWN PROPERTY: SoftObjectProperty
	...
	unsigned char                                      UnknownData_W26N[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OQ95[0x6];                                     // 0x00B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AA2H[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (PADDING)
...
struct FKillerItemDependencies
{
	...
	unsigned char                                      UnknownData_C6TZ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaRitualUIData
{
	...
	unsigned char                                      UnknownData_2TB2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9U5P[0x2];                                     // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QG0V[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaTutorialEndReward : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_3PHQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4E1Q[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       Title;                                                     // 0x0018(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FText                                       Description;                                               // 0x0030(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FString                                     IconPath;                                                  // 0x0048(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_WMJK[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
struct FTutorialNotificationData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_31CN[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAtlantaTutorialTallyData
{
	...
	unsigned char                                      UnknownData_EKUM[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttackEventTypeDetails : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_OK84[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LFLZ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttackHitResult
{
	...
	unsigned char                                      UnknownData_N456[0x66];                                    // 0x001A(0x0066) MISSED OFFSET (PADDING)
...
struct FBloodstoreRowUnlockThreshold : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_H465[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FBloodwebContentTypePerRingDistribution : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_CI8O[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FBloodwebCostModifier : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_G2AR[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlockingNode
{
	...
	unsigned char                                      UnknownData_6DEU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAccessNode
{
	...
	unsigned char                                      UnknownData_5V1W[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FBloodwebNodeCost : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_6RUJ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	DBDSharedTypes_EItemRarity                         Rarity;                                                    // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VQXE[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                Cost;                                                      // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FCloudInventoryItem
{
	...
	unsigned char                                      UnknownData_OSDT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerStateData
{
	...
	unsigned char                                      UnknownData_SEV4[0x1];                                     // 0x0033(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserGameStats
{
	...
	unsigned char                                      UnknownData_G64T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HEOC[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaRitualInstance
{
	...
	unsigned char                                      UnknownData_VCNO[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O3TI[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAtlantaRitualSet
{
	...
	unsigned char                                      UnknownData_KVYS[0x18];                                    // 0x0020(0x0018) MISSED OFFSET (PADDING)
...
struct FGeneratorQueryHandlePair
{
	...
	unsigned char                                      UnknownData_1I50[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (PADDING)
...
struct FCharmCategorySetting
{
	...
	unsigned char                                      UnknownData_Z3SP[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FScreenshotViewSetting                      Settings;                                                  // 0x0010(0x0028) (Edit, NoDestructor, NativeAccessSpecifierPublic)
...
struct FBundleData
{
	...
	unsigned char                                      UnknownData_866L[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_73DC[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JOKK[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M2PP[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
struct FCharacterCustomizationDataTable : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_1DBM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_F9ZG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCharacterDescription : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_HNFT[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVSJ[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TVNI[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MSFT[0x3];                                     // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5R0F[0x1];                                     // 0x00CF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z3LG[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N7XH[0x3];                                     // 0x0145(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M6SM[0x7];                                     // 0x0199(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CIHU[0x7];                                     // 0x0209(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCharacterDescriptionOverride : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_P1OP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J40G[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)
...
struct FKillerAttributesData
{
	...
	unsigned char                                      UnknownData_Z2AD[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FCharacterInfoData
{
	...
	unsigned char                                      UnknownData_OVIX[0x2];                                     // 0x0296(0x0002) MISSED OFFSET (PADDING)
...
struct FCharacterLevelData
{
	...
	unsigned char                                      UnknownData_C8GY[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCharacterSlideData
{
	...
	unsigned char                                      UnknownData_CAFD[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSnappingData
{
	...
	unsigned char                                      UnknownData_DK54[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6U31[0x120];                                   // 0x0000(0x0120) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y4DS[0x1A0];                                   // 0x0000(0x01A0) MISSED OFFSET (PADDING)
...
struct FContextEventData
{
	...
	unsigned char                                      UnknownData_VZS8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8DDY[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W623[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurrencyPackData : public FItemData
{
	...
	unsigned char                                      UnknownData_REU9[0x7];                                     // 0x01D1(0x0007) MISSED OFFSET (PADDING)
...
struct FCurrencyUIData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_RV1N[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCustomizationCategoryData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_7XMR[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWSN[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_19JU[0x1C8];                                   // 0x0098(0x01C8) MISSED OFFSET (PADDING)
...
struct FDailyRewardData
{
	...
	unsigned char                                      UnknownData_KD3E[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SU9A[0x1];                                     // 0x003F(0x0001) MISSED OFFSET (PADDING)
...
struct FDailyRewardCalendarData
{
	...
	unsigned char                                      UnknownData_8ER2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F409[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FAICamperDodgeTunableRowData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_VHH2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZK60[0x1];                                     // 0x002B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W1VS[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIRoll
{
	...
	unsigned char                                      UnknownData_5O83[0x4];                                     // 0x0020(0x0004) MISSED OFFSET (PADDING)
...
struct FAtlantaRitualSetIndex
{
	...
	unsigned char                                      UnknownData_A8PQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWebPath
{
	unsigned char                                      UnknownData_6API[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FWebNode
{
	unsigned char                                      UnknownData_S860[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FRitualEvent
{
	...
	unsigned char                                      UnknownData_EIEQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HDKD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttackTypeDetails : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_G4KN[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelUpDetails : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_TY5N[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YOKA[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P39U[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FEmblemProgressionDescriptionByQuality
{
	...
	unsigned char                                      UnknownData_UUG8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       Description;                                               // 0x0008(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
struct FEmblemProgressionID
{
	...
	unsigned char                                      UnknownData_844Q[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_M112[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JEP[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLookInputAxisScalingData
{
	...
	unsigned char                                      UnknownData_1VGL[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FPlayerDataSync
{
	...
	unsigned char                                      UnknownData_XRJ5[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDownloadProgression
{
	...
	unsigned char                                      UnknownData_5ESM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MU1U[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MSLG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVWM[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FGameEventDispatcherHandleBP
{
	...
	unsigned char                                      UnknownData_9ZZ2[0x4];                                     // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FGameNotificationData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_87J9[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_AJV7[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayNotificationData
{
	...
	unsigned char                                      UnknownData_0OV3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K4TM[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3MUT[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHintData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_ILFR[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       Title;                                                     // 0x0010(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FText                                       Description;                                               // 0x0028(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FString                                     IconPath;                                                  // 0x0040(0x0010) (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_SO8J[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FHitValidationEditorConfig : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_92CF[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GN9F[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FHookLingerTimerHandleContainer
{
	...
	unsigned char                                      UnknownData_3QW5[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AOLJ[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FInteractionProficiencyProperties : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_IDER[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GDAB[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteractionProficiencyData
{
	...
	unsigned char                                      UnknownData_DDAJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RH06[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteractionRequest
{
	...
	unsigned char                                      UnknownData_ZKQE[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParentItemIDs
{
	...
	unsigned char                                      UnknownData_CZIF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_PJWD[0x88];                                    // 0x0098(0x0088) MISSED OFFSET (PADDING)
...
struct FItemTypeData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_T4W9[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FItemUIData                                 UIData;                                                    // 0x0010(0x00C0) (Edit, NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_EPHO[0x1C];                                    // 0x0000(0x001C) MISSED OFFSET (PADDING)
...
struct FLoadingInfoData
{
	...
	unsigned char                                      UnknownData_ZDLX[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7M0N[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C3WL[0x5];                                     // 0x003B(0x0005) MISSED OFFSET (PADDING)
...
struct FLoadoutSlotUnlockLevelValue : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_GFOC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_E7UG[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
struct FMainMenuButtonData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_RCIE[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3N8D[0x5];                                     // 0x008B(0x0005) MISSED OFFSET (PADDING)
...
struct FProfileLoadEventData
{
	...
	unsigned char                                      UnknownData_2OYF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0MLF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_K025[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPromoPackItemData
{
	...
	unsigned char                                      UnknownData_IX2H[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D8FY[0x14];                                    // 0x001C(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DHDU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4480[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ONB[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2UTD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TEBI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FY1W[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W512[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FRankNameData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_DN54[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FPlayerRoleRankData
{
	...
	unsigned char                                      UnknownData_ESIP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRankTooltipData : public FBaseTooltipData
{
	...
	unsigned char                                      UnknownData_3QMI[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AAFT[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FRankUIData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_XABZ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRarityDistributionValue : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_W0PZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ID;                                                        // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_B49P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZZ32[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FShopTransactionVirtualCurrencyParameters
{
	...
	unsigned char                                      UnknownData_L5JQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMenuCharacterUIData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_UHL2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FNodeContentDistributionValue : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_LYOI[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FOffering
{
	unsigned char                                      UnknownData_I6RB[0x208];                                   // 0x0000(0x0208) MISSED OFFSET (PADDING)
...
struct FOfferingEffect
{
	...
	unsigned char                                      UnknownData_4VNI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOfferingProperties : public FItemData
{
	...
	unsigned char                                      UnknownData_909E[0x7];                                     // 0x01D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOfferingCategoryData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_3MUK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1DX6[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6DDV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_S7IR[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ID;                                                        // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NT9O[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FItemUIData                                 UIData;                                                    // 0x0018(0x00C0) (Edit, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_LXHJ[0x7];                                     // 0x0149(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SZVS[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FPerkProperties : public FItemData
{
	...
	unsigned char                                      UnknownData_J8WY[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
struct FPlatformDlcData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_NBNF[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerReadyStatusData
{
	...
	unsigned char                                      UnknownData_51A8[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (PADDING)
...
struct FPlayerRankData
{
	...
	unsigned char                                      UnknownData_8MF4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerRoundStartEventData
{
	...
	unsigned char                                      UnknownData_K83O[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPreLevelGenerationModifierProperties : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_5XGF[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9SKV[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FPrestigeIconData : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_V2E4[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FProceduralMap : public FDBDTableRowBase
{
	...
	unsigned char                                      UnknownData_RY7I[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       Name;                                                      // 0x0018(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_3O84[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BIKX[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FLevelReadyToPlayRequirements
{
	...
	unsigned char                                      UnknownData_SQ14[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
{
	struct FName                                       ThemeName;                                                 // 0x0000(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FXBX[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8PFZ[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H0I8[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	struct FName                                       label;                                                     // 0x0000(0x000C) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JP9U[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStatusEffectSlotData
{
	...
	unsigned char                                      UnknownData_FK7V[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteractButtonInfo : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_Q7BN[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VY3E[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInboxMessageElapsedTime
{
	...
	unsigned char                                      UnknownData_QRIW[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
