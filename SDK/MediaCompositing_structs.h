...
{
	class UMediaSource*                                MediaSource;                                               // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFrameNumber                                SectionStartFrame;                                         // 0x0060(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                               bLoop;                                                     // 0x0064(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_VI57[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_VN3K[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
