...
{
public:
	unsigned char                                      UnknownData_3SHQ[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3QJC[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H7ZU[0x3];                                     // 0x00E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GP7P[0x18];                                    // 0x00F8(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7ZG1[0x4];                                     // 0x00B8(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AOB7[0x4];                                     // 0x00C8(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6DYN[0x4];                                     // 0x00D0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NXBH[0x10];                                    // 0x00D8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D0SB[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2649[0x8];                                     // 0x0508(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DGWP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DI32[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKV5[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H4GC[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VPH8[0x28];                                    // 0x0100(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GKTG[0x10];                                    // 0x0170(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NZ4A[0x10];                                    // 0x0240(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_31AX[0x28];                                    // 0x00B8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YW2[0x7];                                     // 0x00E1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0PGK[0x18];                                    // 0x0058(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4R47[0xC];                                     // 0x00CC(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VHAR[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5KRF[0x2F];                                    // 0x01D1(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4804[0x18];                                    // 0x0130(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U0TP[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DW2G[0x3];                                     // 0x0111(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WDVB[0x98];                                    // 0x01C0(0x0098) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8DIW[0x68];                                    // 0x0070(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ES2P[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SZ2X[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_U3OG[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6HGY[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JVSN[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NYWZ[0x8];                                     // 0x0108(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S9AU[0xC];                                     // 0x0544(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9FT4[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1CQ6[0x58];                                    // 0x00C8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DT59[0x4];                                     // 0x0158(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OPJO[0x3];                                     // 0x015D(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2VMV[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MYID[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2HH3[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X5GA[0x58];                                    // 0x00B8(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ECDD[0x6C];                                    // 0x0114(0x006C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TAWZ[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RN58[0x48];                                    // 0x00D0(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4G5X[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W0TN[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FBVJ[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SIVE[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EW1Y[0xB8];                                    // 0x00D8(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0TU4[0x48];                                    // 0x00C8(0x0048) MISSED OFFSET (PADDING)
