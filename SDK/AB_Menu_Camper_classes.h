...
public:
	...
	unsigned char                                      UnknownData_DH7Q[0x3];                                     // 0x1A81(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XJZI[0x2];                                     // 0x1A8E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Camper.AB_Menu_Camper_C");
		return ptr;
	}
