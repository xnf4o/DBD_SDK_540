...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_L5N2[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VLZP[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
...
struct FAssetBundleEntry
{
	...
	unsigned char                                      UnknownData_UD3S[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_YOI8[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
struct FTagAndValue
{
	...
	unsigned char                                      UnknownData_S4IK[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
