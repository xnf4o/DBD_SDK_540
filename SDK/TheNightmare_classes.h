...
public:
	...
	unsigned char                                      UnknownData_O0NZ[0x18];                                    // 0x02C0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PJ5V[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_X5MQ[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_8JBG[0x40];                                    // 0x06E8(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7OGA[0x8];                                     // 0x0738(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XXFS[0x2];                                     // 0x0772(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7D84[0x8];                                     // 0x0798(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MK06[0x1F];                                    // 0x04F1(0x001F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XMLX[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_YDHW[0x8];                                     // 0x05C0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_JN7C[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0KS0[0x4];                                     // 0x06D8(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_BH6Y[0xC];                                     // 0x06E4(0x000C) MISSED OFFSET (PADDING)
