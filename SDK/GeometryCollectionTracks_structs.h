...
{
	unsigned char                                      UnknownData_M1K4[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HQB9[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
