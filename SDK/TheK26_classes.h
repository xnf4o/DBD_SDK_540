...
public:
	...
	unsigned char                                      UnknownData_PWTR[0x18];                                    // 0x0408(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RQNU[0x8];                                     // 0x04A8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CBGO[0x4];                                     // 0x0364(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M4TU[0x28];                                    // 0x03E8(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3D3U[0x2C];                                    // 0x039C(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2EMI[0x8];                                     // 0x04F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_2WTG[0xC];                                     // 0x0584(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BNF3[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SJJW[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KA8V[0x2];                                     // 0x0366(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PBZ6[0x9C];                                    // 0x03B4(0x009C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OB68[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_DG63[0x30];                                    // 0x0230(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_87O5[0x10];                                    // 0x0280(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TheK26_EFK26AttachedCrowRemovalReason              _lastRemovalReason;                                        // 0x03B1(0x0001) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OZWM[0x86];                                    // 0x03B2(0x0086) MISSED OFFSET (PADDING)
	...
	void Multicast_OnDetached(TheK26_EFK26AttachedCrowRemovalReason removalReason);
	void Multicast_OnAttached();
	void HideOutline();
...
public:
	...
	unsigned char                                      UnknownData_9GP1[0xE];                                     // 0x04F2(0x000E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FLNX[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JPTC[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y085[0x4];                                     // 0x05E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TOWR[0x3];                                     // 0x05FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QFX6[0x10];                                    // 0x06A8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7IYJ[0x3];                                     // 0x06C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CB7I[0x4];                                     // 0x06DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5V1I[0xD8];                                    // 0x0700(0x00D8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MQZG[0x1];                                     // 0x0277(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6DXW[0x24];                                    // 0x027C(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L4PT[0x8];                                     // 0x02A8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ONJV[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FK6B[0xF];                                     // 0x0761(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J0X0[0x8];                                     // 0x05D8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PF3Z[0x8];                                     // 0x00F8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2645[0x20];                                    // 0x00F8(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EXNL[0x7];                                     // 0x03D9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NAAF[0x4];                                     // 0x035C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FDBDTunableRowHandle                        _lingerTime;                                               // 0x0360(0x0028) (Edit, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_MX8D[0x28];                                    // 0x0388(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J9L6[0x4];                                     // 0x03FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KCVI[0x8];                                     // 0x0430(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G501[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_5PSK[0x48];                                    // 0x01E8(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VAWJ[0x6];                                     // 0x0262(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_9TI1[0x6];                                     // 0x00D2(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AY1M[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R42C[0x18];                                    // 0x00D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OBMA[0x4];                                     // 0x017C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ZAJB[0x7];                                     // 0x0859(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XP7M[0x6];                                     // 0x087A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XCUM[0x68];                                    // 0x0888(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_04M4[0x4];                                     // 0x03DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_85MM[0x28];                                    // 0x0260(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T5FY[0x4];                                     // 0x05B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HHK3[0x8];                                     // 0x05C8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MU7E[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (PADDING)
