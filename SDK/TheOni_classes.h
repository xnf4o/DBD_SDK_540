...
{
public:
	unsigned char                                      UnknownData_R7D8[0x40];                                    // 0x05B0(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YHJ1[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B4KY[0x7];                                     // 0x0259(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2BZM[0x28];                                    // 0x0268(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WO56[0x1C];                                    // 0x00E4(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_PD6P[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8CYW[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X4TH[0x20];                                    // 0x0108(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R3VR[0x80];                                    // 0x00B8(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RKVL[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CRKD[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HX40[0x34];                                    // 0x00C4(0x0034) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DEAV[0x28];                                    // 0x0350(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_MKGI[0x60];                                    // 0x00C8(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4URO[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZBAV[0x34];                                    // 0x0148(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PZ6M[0x53];                                    // 0x017D(0x0053) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TP8Q[0x20];                                    // 0x05B0(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PNMW[0x20];                                    // 0x00B8(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CW6H[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_5453[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XFAH[0x10];                                    // 0x0360(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7MVZ[0x1F];                                    // 0x0271(0x001F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NC3O[0x4];                                     // 0x06EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J75H[0x28];                                    // 0x06F8(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_YGI5[0x20];                                    // 0x0360(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GTWF[0x10];                                    // 0x0130(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D002[0x30];                                    // 0x0118(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DUYN[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_DRY2[0x8];                                     // 0x06E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_V0BW[0x8];                                     // 0x0298(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5U9V[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U6U5[0x50];                                    // 0x02F8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R4SR[0x8];                                     // 0x06D8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_MFQA[0x20];                                    // 0x0700(0x0020) MISSED OFFSET (PADDING)
