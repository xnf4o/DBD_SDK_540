...
public:
	...
	unsigned char                                      UnknownData_TJSC[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_91GV[0x4];                                     // 0x01F4(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_50MG[0x20];                                    // 0x0170(0x0020) MISSED OFFSET (PADDING)
