...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UMG.Button.OnLongPressTimerFinished");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function UMG.DragDropOperation.DraggedVisual");
