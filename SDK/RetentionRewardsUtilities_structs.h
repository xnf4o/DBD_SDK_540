...
struct FRetentionReward
{
	...
	unsigned char                                      UnknownData_QHCV[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRetentionCalendar
{
	...
	unsigned char                                      UnknownData_T120[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCampaignStatus
{
	...
	unsigned char                                      UnknownData_8MW9[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClaimStatus
{
	...
	unsigned char                                      UnknownData_58D3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
