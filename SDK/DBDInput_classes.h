...
{
public:
	unsigned char                                      UnknownData_VY0G[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_S8LJ[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SQUX[0x38];                                    // 0x0078(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9SKX[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2Q4Y[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J67E[0x38];                                    // 0x0038(0x0038) MISSED OFFSET (PADDING)
