...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameflowNotifications.GameflowEventsNotifier");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class GameflowNotifications.PlayerflowEventsNotifier");
		return ptr;
	}
