...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_XLBN[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_5SRA[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_WSGG[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_WIOO[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5WGQ[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_K6SL[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_RLWB[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_Y65D[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_NT50[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_VMEH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDB3[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OJY8[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_IRI9[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_A625[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_A7HI[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_B0QU[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_TGOJ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_7HE7[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_8DIZ[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_V25J[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_F6H9[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_POLK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_VTRL[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_D8JL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkWindowsAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AOY4[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkWinGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NJXE[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_STTY[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ML7K[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXSXAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WNPK[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_2KMH[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_XI1K[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_2D3T[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_WNZB[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VWP9[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WKN8[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7D7N[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_R0V2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JAD2[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_IVCT[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
