...
public:
	...
	unsigned char                                      UnknownData_2TMV[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PIGE[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X57P[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (PADDING)
