...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_BHIR[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FCachedPropertyPath
{
	...
	unsigned char                                      UnknownData_P79B[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZQM[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
