...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.CatalogValidationCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.CustomizationValidationCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.DataTableToCsvCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.FixCustomizationAccessorySocketCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.GenerateCurveFloatNetIdTableCommandlet");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_QZ60[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.GenerateStoreCustomizationExclusionFileCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.JournalsValidationCommandlet");
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_HXNK[0x28];                                    // 0x0088(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.LoadoutExportCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.StoryDescriptionValidationCommandlet");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class CommandletPlugin.UpdateJournalVignetteCinematicsCommandlet");
		return ptr;
	}
