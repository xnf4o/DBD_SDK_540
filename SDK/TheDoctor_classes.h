...
{
public:
	unsigned char                                      UnknownData_6HGD[0x8];                                     // 0x05A8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_J4D2[0xF];                                     // 0x04F1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AKVK[0x1C];                                    // 0x03DC(0x001C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DM83[0x8];                                     // 0x0350(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EKDX[0xD4];                                    // 0x035C(0x00D4) MISSED OFFSET (PADDING)
