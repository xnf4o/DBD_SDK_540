...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BonusSkillCheckZoneSizeProficiency.BonusSkillCheckZoneSizeProficiency_C.GetValue");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BonusSkillCheckZoneSizeProficiency.BonusSkillCheckZoneSizeProficiency_C.GetIsActive");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BonusSkillCheckZoneSizeProficiency.BonusSkillCheckZoneSizeProficiency_C.GetType");
