...
{
	unsigned char                                      UnknownData_IFWS[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6M6D[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FUserPlatform                               platform;                                                  // 0x0020(0x0010) (HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_QNE4[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FUniqueNetIdRepl                            PlatformUniqueId;                                          // 0x0060(0x0028) (HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_7JNK[0x30];                                    // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     PlatformSessionId;                                         // 0x00B8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_FN9W[0x30];                                    // 0x00C8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ED3F[0x37];                                    // 0x00F9(0x0037) MISSED OFFSET (PADDING)
...
struct FPartyPlatformSessionInfo
{
	...
	unsigned char                                      UnknownData_KE9Z[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSocialChatChannelConfig
{
	...
	unsigned char                                      UnknownData_CPRE[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_114A[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YIWR[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPartyPrivacySettings                       PrivacySettings;                                           // 0x0020(0x0003) (NoDestructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_3MWS[0x35];                                    // 0x0023(0x0035) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_22WB[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
