...
{
public:
	unsigned char                                      UnknownData_HS55[0x4];                                     // 0x0B6C(0x0004) Fix Super Size
	unsigned char                                      UnknownData_HUUW[0x18];                                    // 0x0B70(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BXLC[0x7];                                     // 0x0B89(0x0007) MISSED OFFSET (PADDING)
