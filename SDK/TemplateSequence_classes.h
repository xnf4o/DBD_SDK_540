...
{
public:
	unsigned char                                      UnknownData_ZU1S[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RN0F[0x4];                                     // 0x024C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EWTM[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N9K7[0x8];                                     // 0x0890(0x0008) MISSED OFFSET (PADDING)
