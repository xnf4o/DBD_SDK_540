...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Slasher21.AB_Menu_Slasher21_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_Menu_Slasher21(int EntryPoint);
};
