...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_KU85[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_RFUC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPTQ[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       MaskName;                                                  // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ClothingSystemRuntimeCommon_EWeightMapTargetCommon CurrentTarget;                                             // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2Z13[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GU46[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
