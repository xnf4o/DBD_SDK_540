...
{
	unsigned char                                      UnknownData_6Q0E[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1J6[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H8CS[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W6OX[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
...
struct FActorsInRangeBool
{
	...
	bool                                               _inRange;                                                  // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_HA1W[0x23];                                    // 0x001D(0x0023) MISSED OFFSET (PADDING)
