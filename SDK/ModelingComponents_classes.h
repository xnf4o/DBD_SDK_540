...
{
public:
	unsigned char                                      UnknownData_SACE[0x8];                                     // 0x0478(0x0008) Fix Super Size
	unsigned char                                      UnknownData_KD76[0x40];                                    // 0x0480(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LZWQ[0x578];                                   // 0x0038(0x0578) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1HBF[0xA0];                                    // 0x0038(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D5AJ[0x10];                                    // 0x00E8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1Z3N[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3W7T[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QQ4W[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4FVA[0xB0];                                    // 0x0030(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BS9N[0x50];                                    // 0x00F0(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DDPC[0x18];                                    // 0x04C0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZJJH[0xF7];                                    // 0x04D9(0x00F7) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7Q0B[0x448];                                   // 0x0038(0x0448) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UPNE[0x43];                                    // 0x049D(0x0043) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1Z34[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BRBQ[0xE];                                     // 0x004A(0x000E) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LU5D[0xD0];                                    // 0x0060(0x00D0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B80B[0x3E0];                                   // 0x0130(0x03E0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H8JI[0x5];                                     // 0x005B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L5IF[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LM2O[0x560];                                   // 0x0060(0x0560) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YD4K[0x1F];                                    // 0x04C1(0x001F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8FHE[0x4F];                                    // 0x04E1(0x004F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y2KX[0xAF];                                    // 0x0531(0x00AF) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_M8ZE[0x418];                                   // 0x0038(0x0418) MISSED OFFSET (PADDING)
