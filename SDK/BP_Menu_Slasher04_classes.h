...
{
public:
	unsigned char                                      UnknownData_DHRU[0x4];                                     // 0x068C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Menu_Slasher04.BP_Menu_Slasher04_C");
		return ptr;
	}
