...
struct FFootBoneData
{
	...
	unsigned char                                      UnknownData_5Z8I[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2P79[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
