...
struct FModifierReplicatedEventConditionData
{
	...
	unsigned char                                      UnknownData_44OO[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SFKZ[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5UAD[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
