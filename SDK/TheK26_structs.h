...
struct FK26SurvivorStatus
{
	...
	unsigned char                                      UnknownData_UIXW[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FK26PathData
{
	...
	unsigned char                                      UnknownData_UTBM[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MM57[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
