...
{
public:
	unsigned char                                      UnknownData_M9U5[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_KOPQ[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
public:
	class UMaterialInstanceDynamic*                    MaterialInstance;                                          // 0x0030(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TGB7[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ML61[0x98];                                    // 0x0050(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
