...
struct FButtonSequenceData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_EMMA[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IISQ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZVM0[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
