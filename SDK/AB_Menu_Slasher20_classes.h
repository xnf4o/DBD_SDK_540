...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Slasher20.AB_Menu_Slasher20_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AB_Menu_Slasher20(int EntryPoint);
};
