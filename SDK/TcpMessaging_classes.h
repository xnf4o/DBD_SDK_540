...
public:
	...
	unsigned char                                      UnknownData_WRZC[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_83PO[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
