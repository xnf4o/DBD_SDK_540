...
{
public:
	unsigned char                                      UnknownData_H2IE[0x8];                                     // 0x06D8(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_2AR0[0xC];                                     // 0x029C(0x000C) MISSED OFFSET (PADDING)
...
public:
	float                                              _speedIncreasePerDash;                                     // 0x0298(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_TDSZ[0xC];                                     // 0x029C(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CUZB[0x3];                                     // 0x029D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_56C1[0x20];                                    // 0x02E0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_K0CC[0x3];                                     // 0x05B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YGFW[0x4];                                     // 0x05BC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TEW6[0x40];                                    // 0x05E0(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8C6D[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EXXM[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQC2[0xF];                                     // 0x0169(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JZNS[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O1G7[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6M2H[0x10];                                    // 0x01B0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SCVH[0x20];                                    // 0x0220(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2QII[0x28];                                    // 0x0240(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FD8D[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O2RC[0x18];                                    // 0x0198(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZU0H[0x7];                                     // 0x01D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RAC5[0x38];                                    // 0x02D8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4J4I[0x3];                                     // 0x01B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9M92[0x7];                                     // 0x0279(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MSGY[0x7];                                     // 0x0241(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CXX0[0xF];                                     // 0x03E9(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VBFU[0xB];                                     // 0x03FD(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_RYJ4[0x58];                                    // 0x0440(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A3VB[0x4];                                     // 0x04A4(0x0004) MISSED OFFSET (PADDING)
