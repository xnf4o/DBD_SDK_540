...
public:
	...
	unsigned char                                      UnknownData_TTAR[0x3];                                     // 0x00D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Audio_KLR_Base.BP_Audio_KLR_Base_C");
		return ptr;
	}
