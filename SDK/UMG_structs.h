...
struct FNamedSlotBinding
{
	...
	unsigned char                                      UnknownData_BB3K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationEventBinding
{
	...
	struct FScriptDelegate                             Delegate;                                                  // 0x0008(0x0010) ELEMENT_SIZE_MISMATCH (ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1UZ3[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	UMG_EWidgetAnimationEvent                          AnimationEvent;                                            // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8LZM[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       UserTag;                                                   // 0x0020(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q5RA[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_U34B[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_D4WE[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	struct FName                                       SlotWidgetName;                                            // 0x000C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_RNH2[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_B1BG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       AnimationToBind;                                           // 0x0004(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       FunctionNameToBind;                                        // 0x0010(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       UserTag;                                                   // 0x001C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FDelegateRuntimeBinding
{
	...
	struct FName                                       PropertyName;                                              // 0x0010(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       FunctionName;                                              // 0x001C(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDynamicPropertyPath                        SourcePath;                                                // 0x0028(0x0028) (NativeAccessSpecifierPublic)
	UMG_EBindingKind                                   Kind;                                                      // 0x0050(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I238[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_9XJP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       WidgetToFocus;                                             // 0x0004(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FScriptDelegate                             CustomDelegate;                                            // 0x0018(0x0010) ELEMENT_SIZE_MISMATCH (ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RUCN[0x4];                                     // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEventReply
{
	unsigned char                                      UnknownData_0KX9[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U5JG[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	struct FMovieSceneFloatChannel                     Translation[0x2];                                          // 0x0058(0x0140) (NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                     Rotation;                                                  // 0x0198(0x00A0) (NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                     Scale[0x2];                                                // 0x0238(0x0140) (NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                     Shear[0x2];                                                // 0x0378(0x0140) (NativeAccessSpecifierPrivate)
	MovieScene_EMovieSceneBlendType                    BlendType;                                                 // 0x04B8(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_UDRC[0x3];                                     // 0x04B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	MovieScene_EMovieSceneBlendType                    BlendType;                                                 // 0x02D8(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_OEVQ[0x7];                                     // 0x02D9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OD7W[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
