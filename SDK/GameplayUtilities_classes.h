...
{
public:
	unsigned char                                      UnknownData_GJ9S[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_VU2I[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_2LBR[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D5RA[0x18];                                    // 0x00B8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJA7[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9MPI[0x1C];                                    // 0x0454(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YWAK[0x1C];                                    // 0x00BC(0x001C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WJ1X[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S1FR[0x8];                                     // 0x0198(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NP2I[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0FNH[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V9I5[0x10];                                    // 0x0138(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3GVN[0x6];                                     // 0x014A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FActivationDefinition                       _activationDefinition;                                     // 0x0150(0x0028) (Edit, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_A5CL[0x8];                                     // 0x0178(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JZBX[0x1B];                                    // 0x0295(0x001B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_FPBS[0x38];                                    // 0x00B8(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J8CQ[0x8];                                     // 0x00D0(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CD12[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (PADDING)
