...
struct FRewardItem
{
	...
	unsigned char                                      UnknownData_KS7D[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZWE[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
