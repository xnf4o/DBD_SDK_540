...
public:
	...
	unsigned char                                      UnknownData_2VTX[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RZZJ[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3T04[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
