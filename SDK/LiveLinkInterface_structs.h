...
struct FLiveLinkSourceBufferManagementSettings
{
	...
	unsigned char                                      UnknownData_GKSD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O9QT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KH72[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYJS[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LGM9[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HSTP[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FIBY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KU7R[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9UA5[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CB12[0x160];                                   // 0x0000(0x0160) MISSED OFFSET (PADDING)
...
struct FSubjectMetadata
{
	...
	unsigned char                                      UnknownData_DIPO[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
struct FLiveLinkBaseFrameData
{
	...
	unsigned char                                      UnknownData_5V3I[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_M8HF[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_ILE8[0xB];                                     // 0x00E5(0x000B) MISSED OFFSET (PADDING)
...
struct FLiveLinkCameraBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_QETU[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkLightStaticData : public FLiveLinkTransformStaticData
{
	...
	unsigned char                                      UnknownData_RQBZ[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightFrameData : public FLiveLinkTransformFrameData
{
	...
	unsigned char                                      UnknownData_QLOZ[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FLiveLinkLightBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_IIU9[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FLiveLinkSubjectKey                         Key;                                                       // 0x0000(0x001C) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_UOWO[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      Role;                                                      // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULiveLinkSubjectSettings*                    Settings;                                                  // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULiveLinkVirtualSubject*                     VirtualSubject;                                            // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               bEnabled;                                                  // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HZJ5[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FLiveLinkSubjectRepresentation
{
	...
	unsigned char                                      UnknownData_PRAO[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UClass*                                      Role;                                                      // 0x0010(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLiveLinkInterpolationSettings
{
	...
	unsigned char                                      UnknownData_VYB0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLiveLinkSourceDebugInfo
{
	...
	int                                                SnapshotIndex;                                             // 0x000C(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                NumberOfBufferAtSnapshot;                                  // 0x0010(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLiveLinkTransformBlueprintData : public FLiveLinkBaseBlueprintData
{
	...
	unsigned char                                      UnknownData_ACL5[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FName                                       CurveName;                                                 // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
