...
public:
	...
	unsigned char                                      UnknownData_ZC05[0x14];                                    // 0x00C0(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D055[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (PADDING)
