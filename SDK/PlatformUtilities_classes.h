...
{
public:
	unsigned char                                      UnknownData_1HU8[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W762[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MMVO[0x30];                                    // 0x0038(0x0030) MISSED OFFSET (PADDING)
